        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6 text-gray-700 text-sm">
            <div className="flex items-center gap-4">
              ...
              <div className="phone flex flex-col gap-4">
                <p className="underline"> <a href="tel:6474099936">+1 (647) 409-9936</a></p>
                <p className="underline"> <a href="tel:6132914770">+1 (613) 291-4770</a></p>
              </div>
